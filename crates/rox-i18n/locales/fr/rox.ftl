...
settings-appearance-milkdrop-favorites = Favoris seulement
    .description = Mélanger parmi les presets étoilés plutôt que toute la bibliothèque
...
health-desc-writable = Pistes dans des formats que rox sait lire mais dans lesquels il ne peut pas réécrire les tags. Les fichiers MP4 fragmentés refusent aussi l'écriture, et ils ne sont pas comptés ici.
...
milkdrop-preset-capped = Affichage des { $shown } premières correspondances sur { $count }. Affine le filtre pour voir le reste.
...
milkdrop-fade = Fondu
    .description = Fondre à l'arrêt de la lecture au lieu de couper net vers le fond du panneau. Un morceau en pause garde son dernier rendu dans les deux cas
