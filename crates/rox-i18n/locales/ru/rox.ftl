...
settings-appearance-milkdrop-favorites = Только избранное
    .description = Перемешивать отмеченные пресеты вместо всей библиотеки
...
milkdrop-preset-capped = Показаны первые { $shown } из { $count } совпадений. Уточните фильтр, чтобы увидеть остальные.
...
milkdrop-fade = Затухание
    .description = Затухать при остановке вместо резкого перехода к фону панели. Трек на паузе в любом случае держит последний кадр
