...
settings-appearance-milkdrop-favorites = Solo preferiti
    .description = Mescolare tra i preset contrassegnati invece che nell'intera libreria
...
milkdrop-preset-capped = Mostrate le prime { $shown } corrispondenze su { $count }. Restringi il filtro per vedere il resto.
...
milkdrop-fade = Dissolvenza
    .description = Dissolvi quando la riproduzione si ferma invece di tagliare netto sullo sfondo del pannello. Un brano in pausa tiene comunque il suo ultimo fotogramma
