...
settings-appearance-milkdrop-favorites = Nur Favoriten
    .description = Aus den markierten Presets mischen statt aus der ganzen Bibliothek
...
milkdrop-preset-capped = Es werden die ersten { $shown } von { $count } Treffern gezeigt. Grenze den Filter weiter ein, um den Rest zu sehen.
...
milkdrop-fade = Überblendung
    .description = Beim Stoppen ausblenden statt direkt zum Panel-Hintergrund zu schneiden. Ein pausierter Titel hält so oder so sein letztes Bild
