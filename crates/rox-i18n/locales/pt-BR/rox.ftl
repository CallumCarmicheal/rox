...
settings-appearance-milkdrop-favorites = Só favoritos
    .description = Embaralhar entre os presets marcados em vez da biblioteca inteira
...
milkdrop-preset-capped = Mostrando as primeiras { $shown } de { $count } correspondências. Refine o filtro para ver o resto.
...
milkdrop-fade = Fade
    .description = Fazer fade ao parar a reprodução em vez de cortar direto para o fundo do painel. Uma faixa pausada segura o último quadro de qualquer jeito
