...
settings-appearance-milkdrop-favorites = Solo favoritos
    .description = Mezclar entre los presets marcados en vez de toda la biblioteca
...
milkdrop-preset-capped = Se muestran las primeras { $shown } de { $count } coincidencias. Afina el filtro para ver el resto.
...
milkdrop-fade = Fundido
    .description = Fundir al parar la reproducción en vez de cortar al fondo del panel. Una pista en pausa mantiene su último fotograma igualmente
