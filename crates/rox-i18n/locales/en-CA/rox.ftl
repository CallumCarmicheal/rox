...
settings-appearance-milkdrop-favorites = Favorites Only
    .description = Shuffle from the presets you've starred instead of the whole library
...
milkdrop-preset-capped = Showing the first { $shown } of { $count } matches. Narrow the filter to reach the rest.
...
milkdrop-fade = Fade
    .description = Fade out when playback stops instead of cutting to the panel background. A paused track holds its last frame either way
