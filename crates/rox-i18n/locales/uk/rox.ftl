...
settings-appearance-milkdrop-favorites = Лише обране
    .description = Перемішувати позначені пресети замість усієї бібліотеки
...
milkdrop-preset-capped = Показано перші { $shown } із { $count } збігів. Уточніть фільтр, щоб побачити решту.
...
milkdrop-fade = Згасання
    .description = Згасати при зупинці замість різкого переходу до фону панелі. Трек на паузі в будь-якому разі тримає останній кадр
